 ...
 * @author user
 */
public class NewJFrameP8 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Potencial Energy, Ep =");

        jLabel2.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        jLabel2.setText("Mass, m =");

        jLabel3.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        jLabel3.setText("Gravity, g =");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            double ans = PhysicsMathSolver.WMGH(W, m, g, h);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new NewJFrameP8().setVisible(true);
            }
        });
    }
